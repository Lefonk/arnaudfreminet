            ...
            btn.addEventListener("click", function(e) {
                ...
                if(this.classList.contains('tpgb-form-click')){
                    ...
                    var windowWidth = window.innerWidth,
                        ...
                        divWidth = jQuery(this)[0].getBoundingClientRect(),
                        padd = jQuery(this).closest('.tpgb-container-col') ? jQuery(this).closest('.tpgb-container-col').css('padding') : jQuery(this).closest('.wp-container-5') ? jQuery(this).closest('.wp-container-5').css('padding') : '' ,
