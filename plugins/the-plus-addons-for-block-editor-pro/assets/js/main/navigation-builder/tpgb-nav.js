( function( $ ) {
	'use strict';
        ...
        $(".tpgb-navbuilder").each(function(){
            var block_id = $(this).data('menu_id');
            /* Js For Show SubMenu on Click  */
            if($(".tpgb-block-"+block_id+" .tpgb-nav-wrap .tpgb-nav-inner.menu-click").length>=1){
                $('.tpgb-block-'+block_id+' .tpgb-nav-wrap .menu-click .tpgb-normal-menu > .navbar-nav li.menu-item-has-children > a,.tpgb-block-'+block_id+' .tpgb-nav-wrap .menu-click .tpgb-mobile-menu > .navbar-nav li.menu-item-has-children > a').on('click', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
            ...
            if($(".tpgb-block-"+block_id+" .tpgb-nav-inner").hasClass("menu-hover")){
                $(".tpgb-block-"+block_id+" .tpgb-nav-wrap .menu-hover .tpgb-normal-menu .tpgb-nav-item > .navbar-nav .dropdown,.tpgb-block-"+block_id+" .tpgb-nav-wrap .menu-hover .tpgb-mobile-menu > .navbar-nav .dropdown").on('mouseenter',function() {
                ...
                $(".tpgb-block-"+block_id+" .tpgb-nav-wrap .menu-hover .tpgb-normal-menu .tpgb-nav-item > .navbar-nav .dropdown-submenu,.tpgb-block-"+block_id+" .tpgb-nav-wrap .menu-hover .tpgb-mobile-menu >  .navbar-nav .dropdown-submenu").on('mouseenter',function() {
        ...
        if($(".tpgb-toggle-menu.hamburger-toggle").length > 0){
            $(".tpgb-toggle-menu.hamburger-toggle").each(function(){
                ...
                $this.on('click',function() {
                    ...
                    if( navWrap.parent(".tpgb-cont-in").length > 0 ){
                        offeset = navWrap.parent(".tpgb-cont-in");
                        offset_left = 0 - offeset.offset().left
        ...
        $(".tpgb-mobile-menu.tpgb-menu-toggle .navbar-nav li.menu-item-has-children > a , .tpgb-mobile-menu.tpgb-menu-off-canvas .navbar-nav li.menu-item-has-children > a").on("click", function(a) {
            ...
            if( d.find('li.dropdown.open ul.dropdown-menu .tpgb-isotope .post-loop-inner').length){
                d.find('li.dropdown.open ul.dropdown-menu .tpgb-isotope .post-loop-inner').isotope('layout');
            }
        });
        /* Js For Toggle Class On Click on the toggle icon  */
