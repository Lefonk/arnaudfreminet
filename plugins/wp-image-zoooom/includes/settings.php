		...
		$settings = array(
			...
			'zwWidth'                    => array(
				...
				'zwResponsiveThreshold'      => array(
					...
					'description' => __( 'The zoom type will automatically switch to No Lens zoom once the browser\'s width becomes less than the threshold. Works only on the frontend, not on this demo.', 'wp-image-zoooom' ),
					'post_input'  => 'px',
					'value'       => 800,
					'input_form'  => 'input_text',
					'validate'    => array(
				...
				'zoomType'                   => array(
					'label'      => __( 'Zoom Type', 'wp-image-zoooom' ),
					'values'     => array(
						'inner' => array( '<i class="icon-type_zoom_inner"></i>', __( 'Inner Zoom', 'wp-image-zoooom' ) ),
						'outer' => array( '<i class="icon-type_zoom_outer"></i>', __( 'Outer Zoom', 'wp-image-zoooom' ) ),
					),
					'value'      => 'inner',
					'input_form' => 'buttons',
					'style'      => 'full',
				...
				'zoomWindowPosition'         => array(
					'label'      => __( 'Zoom Window Position', 'wp-image-zoooom' ),
					'values'     => array(
						'right' => array( '<i class="icon-type_zoom_window_right"></i>', __( 'Right', 'wp-image-zoooom' ) ),
						'left'  => array( '<i class="icon-type_zoom_window_left"></i>', __( 'Left', 'wp-image-zoooom' ) ),
					),
					'value'      => 'right',
					'input_form' => 'buttons',
					'style'      => 'full',
				...
				'remove_lightbox_thumbnails' => array(
					...
					'value'       => true,
					'input_form'  => 'checkbox',
					'description' => __( 'Some themes implement a Lightbox for WooCommerce galleries that opens on click. Enabling this checkbox will remove the Lightbox on thumbnail images and leave it only on the main image', 'wp-image-zoooom' ),
					'section'     => 'general',
				),
			...
			'image_title_position'       => array(
				...
				'values'     => array(
					'false'  => __( 'Do not show', 'wp-image-zoooom' ),
