...
function tableaux_additional_images( $atts ) {
   ...
   if ($additional_images) {
       ...
       $captions = explode(',', $image_captions);
       ...
       foreach ($image_ids as $index => $image_id) {
           ...
           echo '<img src="' . esc_url($full_image_url) . '" alt="Image supplémentaire">';
           if ($caption) {
...
add_shortcode( 'tableaux_images_add', 'tableaux_additional_images');